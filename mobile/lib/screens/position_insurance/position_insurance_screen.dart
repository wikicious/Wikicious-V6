...
class PositionInsuranceScreen extends StatelessWidget {
  const PositionInsuranceScreen({super.key});
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
            Text('Position Insurance', style: TextStyle(fontFamily: 'Syne', fontSize: 14,
              fontWeight: FontWeight.w800, color: Color(0xFFE8F4FF))),
            Text('Pay premium · Insure gap losses · Underwrite to earn', style: TextStyle(fontSize: 10, color: Color(0xFF4E6E90))),
          ]),
        ]),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          _row('Forex coverage', '0.5% per week', const Color(0xFFFFB020)),
          _row('Crypto coverage', '1.5% per week', const Color(0xFFFFB020)),
          _row('Max coverage', 'Up to your position size', const Color(0xFFFFB020)),
          _row('Protocol fee', '10% of premiums', const Color(0xFFFFB020)),
          _row('Underwriter earn', '90% of premiums', const Color(0xFFFFB020)),
          _row('Claim process', 'Instant on-chain', const Color(0xFFFFB020)),
              ]),
            ),
