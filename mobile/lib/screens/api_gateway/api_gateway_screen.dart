...
class APIGatewayScreen extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
            Text('API Gateway', style: TextStyle(fontFamily: 'Syne', fontSize: 14,
              fontWeight: FontWeight.w800, color: Color(0xFFE8F4FF))),
            Text('Programmatic trading · Rate limits · Key management', style: TextStyle(fontSize: 10, color: Color(0xFF4E6E90))),
          ]),
        ]),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          _row('Free tier', '100 orders/day · $100K vol', const Color(0xFF00C8FF)),
          _row('Pro plan', '$50/mo · 10K orders/day', const Color(0xFF00C8FF)),
          _row('Institutional', '$500/mo · Unlimited', const Color(0xFF00C8FF)),
          _row('Your today', '2,841 / 10,000 orders', const Color(0xFF00C8FF)),
          _row('Volume today', '$4.2M / $10M', const Color(0xFF00C8FF)),
          _row('Active keys', '3', const Color(0xFF00C8FF)),
              ]),
            ),
