      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
            Text('Push Notifications', style: TextStyle(fontFamily: 'Syne', fontSize: 14,
              fontWeight: FontWeight.w800, color: Color(0xFFE8F4FF))),
            Text('Set alerts · Health warnings · Prop deadlines', style: TextStyle(fontSize: 10, color: Color(0xFF4E6E90))),
          ]),
        ]),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          _row('Health warning', '< 20% triggers alert', const Color(0xFF0075FF)),
          _row('Health critical', '< 10% triggers urgent', const Color(0xFF0075FF)),
          _row('Prop deadline', 'Challenge ending in 3 days', const Color(0xFF0075FF)),
          _row('Price alerts', 'Any market, any price', const Color(0xFF0075FF)),
          _row('Season ending', '7 days before close', const Color(0xFF0075FF)),
          _row('Telegram link', 'Also supported', const Color(0xFF0075FF)),
              ]),
            ),
