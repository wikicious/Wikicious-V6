...
class SeasonPointsScreen extends StatelessWidget {
  const SeasonPointsScreen({super.key});
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
            Text('Season XP', style: TextStyle(fontFamily: 'Syne', fontSize: 14,
              fontWeight: FontWeight.w800, color: Color(0xFFE8F4FF))),
            Text('Season 1 · 67 days left · 2× streak bonus', style: TextStyle(fontSize: 10, color: Color(0xFF4E6E90))),
          ]),
        ]),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          _row('My XP', '28,420', const Color(0xFFFFB020)),
          _row('My rank', '#142', const Color(0xFFFFB020)),
          _row('Streak', '23 days 🔥', const Color(0xFFFFB020)),
          _row('Multiplier', '2.0×', const Color(0xFFFFB020)),
          _row('Season end', '67 days', const Color(0xFFFFB020)),
          _row('Reward pool', '1,000,000 WIK', const Color(0xFFFFB020)),
              ]),
            ),
