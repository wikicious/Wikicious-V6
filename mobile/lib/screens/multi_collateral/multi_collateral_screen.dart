...
class MultiCollateralScreen extends StatelessWidget {
  const MultiCollateralScreen({super.key});
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
            Text('Multi-Collateral Margin', style: TextStyle(fontFamily: 'Syne', fontSize: 14,
              fontWeight: FontWeight.w800, color: Color(0xFFE8F4FF))),
            Text('Post BTC/ETH/ARB without converting to USDC', style: TextStyle(fontSize: 10, color: Color(0xFF4E6E90))),
          ]),
        ]),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          _row('USDC LTV', '100%', const Color(0xFF00F0A8)),
          _row('WETH LTV', '85%', const Color(0xFF00F0A8)),
          _row('WBTC LTV', '80%', const Color(0xFF00F0A8)),
          _row('ARB LTV', '70%', const Color(0xFF00F0A8)),
          _row('Health factor', 'Must stay > 1.0×', const Color(0xFF00F0A8)),
          _row('Auto-liquidation', 'Keeper bot 24/7', const Color(0xFF00F0A8)),
              ]),
            ),
