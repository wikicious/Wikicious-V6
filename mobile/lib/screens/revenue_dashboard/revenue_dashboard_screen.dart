      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
            Text('Revenue Dashboard', style: TextStyle(fontFamily: 'Syne', fontSize: 14,
              fontWeight: FontWeight.w800, color: Color(0xFFE8F4FF))),
            Text('Public protocol stats · DeFi Llama compatible', style: TextStyle(fontSize: 10, color: Color(0xFF4E6E90))),
          ]),
        ]),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          _row('24h volume', '$48.2M', const Color(0xFF00F0A8)),
          _row('24h fees', '$33,740', const Color(0xFF00F0A8)),
          _row('Total TVL', '$124M', const Color(0xFF00F0A8)),
          _row('Unique traders', '8,420', const Color(0xFF00F0A8)),
          _row('All-time fees', '$1.99M', const Color(0xFF00F0A8)),
          _row('Annualised revenue', '$14.6M', const Color(0xFF00F0A8)),
              ]),
            ),
