...
class YieldAggregatorScreen extends StatelessWidget {
  const YieldAggregatorScreen({super.key});
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
            Text('Yield Aggregator', style: TextStyle(fontFamily: 'Syne', fontSize: 14,
              fontWeight: FontWeight.w800, color: Color(0xFFE8F4FF))),
            Text('Best APY auto-router · All vaults ranked', style: TextStyle(fontSize: 10, color: Color(0xFF4E6E90))),
          ]),
        ]),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          _row('Backstop Vault', '15-25% · 7-day exit', const Color(0xFF00F0A8)),
          _row('Delta-Neutral LP', '~18% · 7-day', const Color(0xFF00F0A8)),
          _row('Funding Arb', '10-15% · 1-3 day', const Color(0xFF00F0A8)),
          _row('Structured Products', '8-52% · weekly', const Color(0xFF00F0A8)),
          _row('Lending Supply', '4-8% · instant', const Color(0xFF00F0A8)),
          _row('Auto-route', 'depositBest() finds highest APY', const Color(0xFF00F0A8)),
              ]),
            ),
            ...
            SizedBox(width: double.infinity,
              child: ElevatedButton(
                ...
                child: Text('Deposit to Best APY',
