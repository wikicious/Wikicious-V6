...
class OptionsVaultsScreen extends ConsumerWidget {
  const OptionsVaultsScreen({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: AppBar(title: const Text('Options Vaults')),
          ...
          Container(
            ...
            child: Center(child: Padding(
              ...
              child: Column(children: const [
                ...
                SizedBox(height: 12),
                Text('Options Vaults', style: TextStyle(color: WikColor.text1, fontSize: 18, fontWeight: FontWeight.w800)),
                SizedBox(height: 6),
                Text('Full Options Vaults interface loading...', style: TextStyle(color: WikColor.text3, fontSize: 13)),
              ]),
            )),
          ),
        ]),
