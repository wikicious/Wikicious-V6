...
class LiqProtectionScreen extends StatelessWidget {
  const LiqProtectionScreen({super.key});
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
            Text('Liquidation Protection', style: TextStyle(fontFamily: 'Syne', fontSize: 14,
              fontWeight: FontWeight.w800, color: Color(0xFFE8F4FF))),
            Text('Monthly subscription · Keeper auto-adds margin', style: TextStyle(fontSize: 10, color: Color(0xFF4E6E90))),
          ]),
        ]),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          _row('Basic plan', '$20/mo · $500/add · $10K max', const Color(0xFF00F0A8)),
          _row('Pro plan', '$50/mo · $5K/add · $100K max', const Color(0xFF00F0A8)),
          _row('Elite plan', '$100/mo · $50K/add · Unlimited', const Color(0xFF00F0A8)),
          _row('Trigger', 'Health below 15%', const Color(0xFF00F0A8)),
          _row('Cooldown', '5 min between adds', const Color(0xFF00F0A8)),
          _row('Reserve', 'You fund, keeper uses', const Color(0xFF00F0A8)),
              ]),
            ),
