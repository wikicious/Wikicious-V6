...
class StructuredProductScreen extends StatelessWidget {
  const StructuredProductScreen({super.key});
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
            Text('Structured Products', style: TextStyle(fontFamily: 'Syne', fontSize: 14,
              fontWeight: FontWeight.w800, color: Color(0xFFE8F4FF))),
            Text('Covered call & put vaults · Weekly epochs', style: TextStyle(fontSize: 10, color: Color(0xFF4E6E90))),
          ]),
        ]),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          _row('Covered Call APY', '~12% weekly premium', const Color(0xFF7C4FFF)),
          _row('Cash-Secured Put APY', '~8% weekly', const Color(0xFF7C4FFF)),
          _row('Principal Protected APY', '~5-20%', const Color(0xFF7C4FFF)),
          _row('Epoch', 'Weekly auto-rolling', const Color(0xFF7C4FFF)),
          _row('Mgmt fee', '1%/year on TVL', const Color(0xFF7C4FFF)),
          _row('Perf fee', '10% of premium', const Color(0xFF7C4FFF)),
              ]),
            ),
