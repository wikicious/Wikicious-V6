...
class IndexPerpsScreen extends ConsumerWidget {
  const IndexPerpsScreen({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: AppBar(title: const Text('Index Perps')),
          ...
          Container(
            ...
            child: Center(child: Padding(
              ...
              child: Column(children: const [
                ...
                SizedBox(height: 12),
                Text('Index Perps', style: TextStyle(color: WikColor.text1, fontSize: 18, fontWeight: FontWeight.w800)),
                SizedBox(height: 6),
                Text('Full Index Perps interface loading...', style: TextStyle(color: WikColor.text3, fontSize: 13)),
              ]),
            )),
          ),
        ]),
