 ...
 *
 * This interface IUniswapV3Router {
...
contract continuously reads the vault health and decides for each
 * incoming trade: "can we safely absorb this internally, or should we forward
 * it to GMX/Camelot/Uniswap and earn a routing fee?"
 *
 * ─── THE DECISION ENGINE ─────────────────────────────────────────────────────
 *
 * Health Score (0–100):
