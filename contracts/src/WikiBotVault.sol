...
contract WikiBotVault is ERC20, Ownable2Step, ReentrancyGuard, Pausable {
    ...
    function _initStrategies() internal {
        strategies[0] = StrategyConfig({
            ...
            bestCondition:      "Low-volatility sideways markets, BTC ranging ±5-10%",
        ...
        strategies[2] = StrategyConfig({
            ...
            name:               "WikiTrendBot",
            description:        "Trend-following using EMA crossovers and ATR-based stops. 40-50% win rate but aims for 3:1 reward/risk ratio — positive expected value over many trades.",
    ...
    function deposit(uint256 strategyId, uint256 amount) external nonReentrant whenNotPaused {
        ...
        require(!vaultStates[strategyId].circuitBreakerTripped, "BV: circuit breaker tripped — deposits paused");
